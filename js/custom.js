$(function(){
	...
	$(window).on("scroll",function(){	
        ...
        if(scroll >= (ht - 200)){
            $('.infor_data').css({'left':'2%'});
            $('.infor_data').find('h2').css({'border-bottom':'2px solid #bbb'});
            $('.infor_data').find('h2, dt, dd').addClass('add_color');
            $('.list').css({'left':'5%','top':'27vw'});
        }
        else{
            $('.infor_data').css({'left':'65%'});
            $('.infor_data').find('h2').css({'border-bottom':'2px solid #fff'});
            $('.infor_data').find('h2, dt, dd').removeClass('add_color');
            $('.list').css({'left':'69%','top':'23vw'});
        };
 ...
 stop.addClass('play_plus');
    ...
    function parallax(){
        var img_02_02_top =  $('article').find('.img_02_02').offset().top,
            img_02_03_top =  $('article').find('.img_02_03').offset().top;
        
        $(window).scroll(function(){
            var p_value = $(this).scrollTop();
            
            $('article').find('.img_02_01').css('background-position-y', p_value);
            
            if(p_value > img_02_02_top){
                $('article').find('.img_02_02').css('background-position-y', p_value - img_02_02_top);
                console.log('img_02_02 variable');
            }else{
                $('article').find('.img_02_02').css('background-position-y', 'top');
                console.log('img_02_02 top');
            }
            
            if(p_value > img_02_03_top){
                $('article').find('.img_02_03').css('background-position-y', (p_value - img_02_03_top) * 2);
                console.log('img_02_03 variable');
            }else{
                $('article').find('.img_02_03').css('background-position-y', 'top');
                console.log('img_02_02 top');
            }
        });
    }
